...
echo ("<h1 class='text-center mt-5'>Record: " . implode(cogeRecordImagen($rankingUsuario)) . "</h1>"); //Mostramos su record
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <img src="../img/<?php echo cogeImagen($numero); ?>" class="img-fluid d-block w-100">
                ...
                <form action="../comprobacion/comprobarRespuesta.php" method="post" autocomplete="off" class="mt-4">
                    ...
                    <div class="form-group">
                        ...
                        <input id="respuesta" type="text" class="form-control" placeholder="Respuesta" name="respuesta"

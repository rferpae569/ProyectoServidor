...
INSERT INTO `numjugadas` VALUES (1,15,14,10),(2,5,2,1),(3,1,2,1),(4,4,1,2),(5,0,0,0);
...
INSERT INTO `peliculasimagenes` VALUES ('Batman Begins',30),('Batman vs Superman: El amanecer de la justicia',4),('Big Fish',5),('E.T., el extraterrestre',29),('Eduardo Manostijeras',8),('El bosque',9),('El caballero oscuro',31),('El cid',7),('El hobbit: Un viaje Inesperado',12),('El hombre bicentenario',32),('El laberinto del fauno',24),('El padrino 2',15),('El planeta de los simios',21),('El señor de los Anillos: Las dos torres',2),('Gremlins',34),('Harry Potter y el cáliz de fuego',11),('Hook',35),('Jumanji',36),('La ballena',3),('La familia addams',22),('La momia',25),('La naranja mecánica',13),('Los siete magníficos',1),('Mars Attacks!',26),('Matrix',28),('Moulin Rouge!',17),('Mrs. Doubtfire',33),('Múltiple',14),('Muñeco diabólico',6),('Pesadillas Antes de Navidad',16),('Regreso al futuro',23),('Shrek',27),('Spider-Man',18),('Star Wars: Episodio III - La venganza de los Sith',19),('Sweeney Todd',20),('Vengadores: EndGame',10);
...
INSERT INTO `ranking` VALUES (1,10,8,6),(2,12,6,7),(3,7,3,0),(4,15,7,7),(5,0,0,0);
...
-- Dump completed on 2023-04-16  0:33:43
